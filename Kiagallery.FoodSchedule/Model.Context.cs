...
namespace Kiagallery.FoodSchedule
{
    ...
    public partial class KiaGalleryMainContextEntities : DbContext
    {
        ...
        public virtual DbSet<FoodCensus> FoodCensus { get; set; }
        public virtual DbSet<FoodRegistrations> FoodRegistrations { get; set; }
        public virtual DbSet<FoodSettings> FoodSettings { get; set; }
    }
}
