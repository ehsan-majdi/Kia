...
using NikSms.Library.Net.WebService;
...
namespace KiaGallery.ScheduleJob
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            var numbers = new List<string>() { "09124254257", "09122196672", "09128639319", "09122010861", "09126046937", "09124598925", "09126904936", "09361604970" , "09354047788" };
            ...
            using (var db = new KiaGalleryMainContextEntities())
            {
                ...
                var managerNumber = new List<string>() { "09124516569", "09126304190", "09124254257", "09123430339", "09128069061", "09127799048", "09359120525","09354047788" };
